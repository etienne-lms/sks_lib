 ...
 * GPD TEE session. TEEC type as abstract throug void pointers
 ...
 * on behalf of the primary TEE session context.
 */
TEEC_SharedMemory *sks_register_shm(struct sks_invoke *ctx,
 ...
 * on behalf of the primary TEE session context.
 *
 * ctrl, in and out can be NULL pointer (no relate data), buffer pointer
 ...
 * - CKR_OK on ivocation succes (TEEC_SUCCESS)
