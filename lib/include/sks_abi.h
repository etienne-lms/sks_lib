 ...
 *				SKS_UNDEFINED_ID is the SKS 32bit ID equivalent in SKS ABI
 *
 * CKA_SKS_SECSTOR_ID		ID of the related TEE persistent object.
...
#define CKA_SKS_SECSTOR_ID		((uint32_t)0x80000001)
